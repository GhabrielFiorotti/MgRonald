...
class Produto
{
    ...
    {
        get { return alface; }
        set { this.alface = value; }
    }
    private int tomate = 0;
    public int Tomate
    {
        get { return tomate; }
        set { this.tomate = value; }
    }
    private int picles = 0;
    public int Picles
    {
        get { return picles; }
        set { this.picles = value; }
    }
    private int batata = 0;
    public int Batata
    {
        get { return batata; }
        set { this.batata = value; }
    }
    private int ovo = 0;
    public int Ovo
    {
    ...
    {
        get { return calabresa; }
        set { this.calabresa = value; }
    }
    private int queijos = 0;
    public int Queijos
    {
        get { return queijos; }
        set { this.queijos = value; }
    }
    private int azeitona = 0;
    public int Azeitona
    {
        get { return azeitona; }
        set { this.azeitona = value; }
    }
    private int casquinha = 0;
    public int Casquinha
    {
        get { return casquinha; }
        set { this.casquinha = value; }
    }
    private int banana;
    public int Banana
    {
        get { return banana; }
        set { this.banana = value; }
    }
    private int frango;
    public int Frango
    {
        get { return Frango; }
        set { this.Frango = value; }
    }
    private int oregano;
    public int Oregano
    {
        get { return oregano; }
        set { this.oregano = value; }
    }
    private int palmito;
    public int Palmito
    {
        get { return palmito; }
        set { this.palmito = value; }
    }
    private int catupiry;
    public int Catupiry
    {
        get { return catupiry; }
        set { this.catupiry = value; }
    }
    private int massa;
    public int Massa
    {
        get { return massa; }
        set { this.massa = value; }
    }
    private int mussarela;
    public int Mussarela
    {
        get { return mussarela; }
        set { this.mussarela = value; }
    }
